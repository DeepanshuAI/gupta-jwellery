export const storeInfo = {
  ...
  maps: {
    embedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3456.789!2d76.8481!3d29.9695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sGupta+Jwellery!5e0!3m2!1sen!2sin!4v1',
    directionsUrl: 'https://www.google.com/maps/dir/?api=1&destination=Gupta+Jwellery+Shop+No+21-22+Market+Rd+Urban+Estate+Sector+7+Kurukshetra+Haryana+136118',
  },
...
export function getProductWhatsAppUrl(productName: string, productUrl?: string): string {
  let message = `Hello Gupta Jwellery, I'm interested in the "${productName}" shown on your website. Could you share more details?`;
  if (productUrl) {
    message += `\n\n${productUrl}`;
  }
